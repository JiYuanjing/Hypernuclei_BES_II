...
dca_he                        dca_he                        dca_he                        dca_he                                                          'F'    [0.00260631972924,8.77715301514]
dca_pi                        dca_pi                        dca_pi                        dca_pi                                                          'F'    [0.00836274772882,12.8832206726]
NSpec 3
...
class ReadCuts : public IClassifierReader {
 ...
 public:
        ...
        fNvars( 7 )
   {
      ...
      const char* inputVars[] = { "chi2primary_pi", "chi2primary_he", "ht_chi2ndf", "ht_chi2topo", "ht_l", "dca_he", "dca_pi" };
